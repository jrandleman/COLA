...
void demo_default_vals(int x, char *str                        , float num        ) { 
...
void COLA__2_overload_defaults(int x, int y) {
  printf("Function \"overload_defaults\" Without Default Values: x = %d & y = %d\n", x, y);
}
void COLA__1_overload_defaults(int x     ) {
...
int main() {
  ...
  demo_default_vals(1, "Hola!",9.999); // Default Value of '9.999' Are Used
  printf("Using the Function \"demo_default_vals\" With its Default Float & String Values:\n\t");
  demo_default_vals(1,"default value used!",9.999); // Default Values of '"default value used!"' && '9.999' Are Used
